...
class RecruiterPanelView(BasePanelView):
    ...
    def __init__(self, owner_id: int, timeout: Optional[float]):
        ...
        # controls
        self.add_item(LabeledSelect("Clan Boss (optional)", CB_LEVELS, "clanboss"))
        self.add_item(LabeledSelect("Hydra (optional)", HYDRA_LEVELS, "hydra"))
        self.add_item(LabeledSelect("Chimera (optional)", CHIMERA_LVLS, "chimera"))
