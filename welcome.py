...
class Welcome(commands.Cog):
    ...
    def __init__(
        ...
        *,
        ...
        c1c_footer_icon_url: Optional[str] = None,
        ...
        self.c1c_footer_icon_url = c1c_footer_icon_url
    ...
    async def welcome(self, ctx: commands.Context, clantag: str, *args):
        ...
        if foot:
            if self.c1c_footer_icon_url:
                embed.set_footer(text=foot, icon_url=self.c1c_footer_icon_url)
            else:
